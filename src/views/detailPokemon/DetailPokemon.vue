<script>
import DefaultLayout from '@/layout/DefaultLayout' // eslint-disable-line no-unused-vars
import PokedexTag from '@/components/PokedexTag' // eslint-disable-line no-unused-vars
export default {
